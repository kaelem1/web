...
export function NewCardBack({ article }: { article: Article }) {
  return (
    <Link href={`/blog/${article.slug}`}>
      <div className="absolute w-full transition-all duration-500 scale-75 z-10 top-0 -rotate-[30deg] blur-[2px] -translate-x-1 bg-white rounded-lg overflow-hidden shadow hover:scale-[0.76] cursor-pointer">
        <div className="p-3">
          <Image 
            src={article.image} 
            alt={article.title} 
